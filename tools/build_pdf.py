...
LANGS = {
    "zh": {
        ...
        "fname": "ai-customer-growth",
        "title": "AI 客户经营",
        "subtitle": "当每个客户都值得被 AI 认真对待时，人做什么",
        "meta": "Jweokk 著 · {today} · v{version}",
        "blurb": "2024 年，Klarna 用 AI 客服顶掉了 700 名全职客服的工作量；2026 年，它的 CEO 说“我们走得太远了”，重新招人。<br>这不是一个“AI 行不行”的故事，而是“AI 时代客户经营怎么做”的缩影——<br>AI 如何重塑客户从开拓、转化、服务到留存的全生命周期：成功与翻车，两面都讲。",
